  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.alertTypeWrap}>
        <button style={styles.typeBtn(alertType === 'buy', '#ef4444')} onClick={() => setAlertType('buy')}>Buy</button>
        <button style={styles.typeBtn(alertType === 'sell', '#22c55e')} onClick={() => setAlertType('sell')}>Sell</button>
      </div>
      <label style={styles.label}>Duration</label>
      <div style={styles.alertTypeWrap}>
        <input type="text" style={styles.input} placeholder="Enter duration in days" />
      </div>
      ...
      <button style={styles.button} onClick={handleCreateAlert} disabled={isCreating}>
