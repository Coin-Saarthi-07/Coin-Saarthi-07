...
public class NotificationDispatcherService {
	...
	public NotificationDispatcherService(EmailSender emailSender, SmsSender smsSender,
	...
	public void dispatch(Notification notification, String email, String phone) {
		try {
			...
			case EMAIL -> emailSender.send(email, "Crypto Alert Triggered", notification.getMessage());

			case SMS -> smsSender.send(normalizePhone(phone), notification.getMessage());

			case APP -> {
				// intentionally disabled
				System.out.println("App notification skipped");
			}
			}
